    ...
    <div class="container">
        <form action="editar.jsp" method="POST">
            ...
            <input type="text" id="idartigo"
             ...
             <label for="tituloartigo" class="form-label">Título do Artigo</label>
             ...
             <label for="conteudoartigo">Preço</label>
            ...
            <button type="submit" id="botaocadastrar" class="btn btn-primary mt-3" disabled>Salvar alterações</button>
        </form>
    </div>

    <hr>
    <button class="btn btn-primary" onclick="checarAdm()">Checar se o adminstrador está logado</button>
